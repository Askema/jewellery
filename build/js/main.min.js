...
/* harmony import */ var _modules_login__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/login */ "./js/modules/login.js");
/* harmony import */ var _modules_login__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_login__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_webp__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/webp */ "./js/modules/webp.js");
/* harmony import */ var _modules_webp__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_webp__WEBPACK_IMPORTED_MODULE_6__);
...
var body = document.querySelector('.body'); // No-js
// ---------------------------------
...
var askContainer = document.querySelectorAll('.ask__container');
var fieldsets = document.querySelectorAll('.filter__fieldset');
askContainer.forEach(function (container) {
  var accordion = container.querySelector('button');
  var accordionPanel = container.querySelector('.ask__panel');
...
fieldsets.forEach(function (fieldset) {
  var accordionButton = fieldset.querySelector('button');
...
var closeButton = document.querySelector('.filter button');
var openButton = document.querySelector('.products button');
...
var loginCloseBtn = document.querySelector('.login button');
var loginOpenBtn = document.querySelector('.nav__user a');
var emailInput = document.querySelector('.login [type="email"]');
var overlay = document.querySelector('.overlay');
var page = document.querySelector('page');
...
var focusableEls = login.querySelectorAll('button:not([disabled]), input[type="text"]:not([disabled]), input[type="checkbox"]:not([disabled]), input[type="email"]:not([disabled]), input[type="password"]:not([disabled]), button[type="button"]:not([disabled]), button[type="submit"]:not([disabled]), a:not([disabled])');
...
var navUser = nav.querySelector('.nav__user');
var navLogo = nav.querySelector('.nav__logo');
var menuButton = nav.querySelector('button');
var page = document.querySelector('.page');
...
var body = document.querySelector('.body'); // Проверяем, можно ли использовать Webp формат
